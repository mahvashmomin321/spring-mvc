...
<body>
  ...
  <div class="container">
    <form action="/bankApp/app/bank/checkB" method="post" class="form-box1">
      <h1 class="form-heading1">Check Balance</h1>
      <div class="row">
      ...
      <input type="submit" class="btn btn-primary sbtn1" value="Get Balance">
    </form>
	</div>
</body>
</html>