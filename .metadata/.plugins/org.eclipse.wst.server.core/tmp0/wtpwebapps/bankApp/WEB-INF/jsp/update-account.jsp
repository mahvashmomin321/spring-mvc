...
<body>
  ...
  <div class="container">
    <form class="form-box1" action="/bankApp/app/bank/update-acc" method="post">
      <h1 class="form-heading1">Update Account</h1>
      <div class="row">
        <div class="form-group col-md-12">
          <label for="inputNumber">Account Id</label>
          <input type="text" class="form-control" name="account_id" id="inputNumber" placeholder="Account Number"  required>
        </div>
      </div>
      
      <input type="submit" class="btn btn-primary sbtn1" value="submit">
    </form>
	</div>
</body>
</html>