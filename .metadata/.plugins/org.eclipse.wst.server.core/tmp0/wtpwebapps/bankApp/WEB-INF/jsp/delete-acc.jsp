...
<body>
  ...
  <div class="container">
    <form action="/bankApp/app/bank/delete" method="post" class="form-box1">
      <h1 class="form-heading1">Delete Account</h1>
      <div class="row">
        <div class="form-group col-md-12">
          <label for="inputNumber">Account Id</label>
          <input type="text" class="form-control" id="inputNumber" name="account_id" placeholder="Account Number"  maxlength="15" required>
        </div>
      </div>
      
      <input type="submit" class="btn btn-primary sbtn1" value="Delete Account">
    </form>
	</div>
</body>
</html>